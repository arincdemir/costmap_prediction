...
def visualize_model_predictions(model, data_tensor, num_samples=10, num_encoding=5, num_query=5):
    """
...
def log_visualizations_to_wandb(model_path, data_path, wandb_run, num_samples=10):
    """
